...
CREATE TABLE `cthd` (
  ...
  `ghiChu` text,
  PRIMARY KEY (`idcthd`),
  KEY `FK_cthd_hoaDon_idx` (`idHoaDon`),
  KEY `FK_cthd_sanPham_idx` (`idSanPham`),
...
CREATE TABLE `hoadon` (
  ...
  KEY `FK_hoaDon_taiKhoan_idx` (`tenTaiKhoan`),
  CONSTRAINT `FK_hoaDon_taiKhoan` FOREIGN KEY (`tenTaiKhoan`) REFERENCES `taikhoan` (`tenTaiKhoan`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-19 10:52:33
